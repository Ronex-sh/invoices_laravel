...
{{--					</li>--}}
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='mail') }}">قائمة المستخدمسين</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='profile') }}">واحد</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='editprofile') }}">اثنان</a></li>
